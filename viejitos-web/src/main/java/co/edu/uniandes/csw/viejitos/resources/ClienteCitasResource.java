...
public class ClienteCitasResource {
     ...
     */
    @GET
    public CitaDetailDTO listCitas(@PathParam("clienteId") Long clienteId) {
        return new CitaDetailDTO(clienteLogic.listCitas(clienteId));
    }
    ...
    public void removeCita(@PathParam("clienteId") Long clienteId, @PathParam("citaId") Long citaId) {
        clienteLogic.removeCita(clienteId,citaId);
    }
