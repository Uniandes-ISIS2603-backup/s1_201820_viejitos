...
/**
 * <pre>Clase que implementa el recurso "enfermeros/{id}/servicios".
 * URL: /api/enfermeros/{enfermeroId}/servicios
 * </pre>
 * <i>Note que la aplicación (definida en {@link RestConfig}) define la ruta "/api" y
 * este recurso tiene la ruta "enfermero/{enfermeroId}/servicios".</i>
 * <h2>Anotaciones </h2>
 * <pre>
...
@Path("enfermeros/{enfermeroId: \\d+}/servicios")
@Consumes(MediaType.APPLICATION_JSON)
@Produces(MediaType.APPLICATION_JSON)
public class EnfermeroServiciosResource {
    ...
    private List<ServicioEntity> serviciosListDTO2Entity(List<ServicioDetailDTO> dtos) {
     ...
     /**
     * <h1>GET /api/enfermeros/{enfermeroId}/servicios : Obtener todos los servicios de una enfermero.</h1>
     * <pre>Busca y devuelve todos los servicios que existen del enfermero.
     ...
     * @return JSONArray {@linkServicioDetailDTO} - Los servicios encontrados del enfermero. Si no hay ninguno retorna una lista vacía.
     */
    @GET
    public List<ServicioDetailDTO> listServicios(@PathParam("enfermeroId") Long enfermeroId) {
        return serviciosListEntity2DTO(enfermeroLogic.listServicios(enfermeroId));
    }
